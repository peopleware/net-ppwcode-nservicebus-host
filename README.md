# PPWCode.NServiceBus.Host

This library is part of the .NET PPWCode project and serves as the base for the Host project in a messaging host solution implemented with NServiceBus.
